...
class Inject {
  static void init() {
    ...
    getIt.registerLazySingleton<GetCarroPorCorDataSource>(() =>
        GetCarrosPorCorDataSourceImp()); //registerLazySingleton - sempre vai ter a mesma instancia do inicio ao fim da aplicação, criado quando é chamado pela primeira vez
    ...
    getIt.registerFactory<CarroController>(() => CarroController(getIt(),
        getIt())); //registerFactory - todas vez que eu recuperar um controller ela vai me gerar uma instancia nova
  }
}
